...
<div class="container">
    <div class="row justify-content-center">
        ...
        <img src="{{ asset('img/as.png') }}" alt="Logo" height="70" width="70" class="" style="opacity: .8">
            <h1>
                SDN MARGAASIH
            </h1>            
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-footer text-center text-secondary">
                    Powered by <a href="#" class="font-weight-bold text-secondary" target="_blank">Jundi</a>.
                </div>
            </div>
        </div>
    </div>
