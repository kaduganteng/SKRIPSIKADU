...
<footer class="main-footer d-none d-md-block">
    ...
    Build With : <a href="#" data-toggle="tooltip" title="Lihat Situs" target="_blank">Jundi</a>
    </div>
    <strong>Copyright &copy; {{ date('Y') }} <a href="#" data-toggle="tooltip" title="Lihat Situs" target="_blank">Jundi</a>.</strong> All rights reserved.
</footer>