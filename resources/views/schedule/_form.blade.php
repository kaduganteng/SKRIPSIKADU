<div class="card-body">
    ...
    <div class="card-header with-border pl-0 pb-1">
        <span class="col-form-label text-bold">Jadwal Guru</span>
    </div>
    <br> 
    <div class="form-group row">
        <label class="col-md-4 col-xs-4 col-form-label justify-flex-end">Nama Guru <span class="text-danger">*</span></label> 
